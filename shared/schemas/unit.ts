...
export type DeleteUnitSchema = z.infer<typeof deleteUnitSchema>;

export const filterUnitsSchema = z.object({
  ...SupplimentalFieldsFilterSet,
  name: FilterSets.string().optional(),
  symbolSingular: FilterSets.discreteValues(unitFields.symbolSingular).optional(),
  symbolPlural: FilterSets.discreteValues(unitFields.symbolPlural).optional(),
});
export type FilterUnitsSchema = z.infer<typeof filterUnitsSchema>;
